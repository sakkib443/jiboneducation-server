...
| Purpose | File Path |
|---------|-----------|
| **Seed Scripts** | `jiboneducation-server/src/scripts/seedReadingTestXX.ts` |
| **MongoDB Schema** | `jiboneducation-server/src/app/modules/reading/reading.model.ts` |
| **Exam Page (Student)** | `jiboneducation-client/src/app/exam/[examId]/reading/page.jsx` |
| **Admin Create** | `jiboneducation-client/src/app/dashboard/admin/reading/create/page.jsx` |
| **Admin Edit** | `jiboneducation-client/src/app/dashboard/admin/reading/edit/[testId]/page.jsx` |
| **This Guide** | `jiboneducation-server/src/scripts/READING_FORMAT_GUIDE.md` |
